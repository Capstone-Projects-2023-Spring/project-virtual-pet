...
function CreateTaskFormMobile({ showCreateTask, handleClose, task }) {
  ...
  return (
    <Modal centered className="createtask-modal-mobile" backdrop="static" show={showCreateTask} onHide={handleClose}>
