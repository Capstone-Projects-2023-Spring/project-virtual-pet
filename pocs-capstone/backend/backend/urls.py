...
urlpatterns = [
    ...
    path('openapi', get_schema_view(title="Study Buddies - User Registration",description="USER Registration, LogIn,LogOut Enpionts",version='0.0.1'),name='openapi-schema'),
